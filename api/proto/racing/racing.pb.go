...
type ListRacesRequestFilter struct {
	...
	RaceVisibility []bool     `protobuf:"varint,2,rep,packed,name=race_visibility,json=raceVisibility,proto3" json:"race_visibility,omitempty"`
	SortOrder      *SortOrder `protobuf:"bytes,3,opt,name=sort_order,json=sortOrder,proto3" json:"sort_order,omitempty"`
}
...
func (x *ListRacesRequestFilter) GetRaceVisibility() []bool {
	if x != nil {
		return x.RaceVisibility
	}
	return nil
}

func (x *ListRacesRequestFilter) GetSortOrder() *SortOrder {
	if x != nil {
		return x.SortOrder
	}
	return nil
...
type SortOrder struct {
	...
	LowToHigh        *bool   `protobuf:"varint,1,opt,name=low_to_high,json=lowToHigh,proto3,oneof" json:"low_to_high,omitempty"`
	Alphabetical     *bool   `protobuf:"varint,2,opt,name=alphabetical,proto3,oneof" json:"alphabetical,omitempty"`
	EarliestToLatest *bool   `protobuf:"varint,3,opt,name=earliest_to_latest,json=earliestToLatest,proto3,oneof" json:"earliest_to_latest,omitempty"`
	OrderedItem      *string `protobuf:"bytes,4,opt,name=ordered_item,json=orderedItem,proto3,oneof" json:"ordered_item,omitempty"`
}
...
func (x *SortOrder) GetLowToHigh() bool {
	if x != nil && x.LowToHigh != nil {
		return *x.LowToHigh
	}
	return false
}

func (x *SortOrder) GetAlphabetical() bool {
	if x != nil && x.Alphabetical != nil {
		return *x.Alphabetical
	}
	return false
}

func (x *SortOrder) GetEarliestToLatest() bool {
	if x != nil && x.EarliestToLatest != nil {
		return *x.EarliestToLatest
	}
	return false
}

func (x *SortOrder) GetOrderedItem() string {
	if x != nil && x.OrderedItem != nil {
...
type Race struct {
	...
	// Race Status is 'CLOSED'|'OPEN' dependent on advertised_start_time.
...
var file_racing_racing_proto_rawDesc = []byte{
	...
	0x03, 0x52, 0x0a, 0x6d, 0x65, 0x65, 0x74, 0x69, 0x6e, 0x67, 0x49, 0x64, 0x73, 0x12, 0x27, 0x0a,
	0x0f, 0x72, 0x61, 0x63, 0x65, 0x5f, 0x76, 0x69, 0x73, 0x69, 0x62, 0x69, 0x6c, 0x69, 0x74, 0x79,
	0x18, 0x02, 0x20, 0x03, 0x28, 0x08, 0x52, 0x0e, 0x72, 0x61, 0x63, 0x65, 0x56, 0x69, 0x73, 0x69,
	0x62, 0x69, 0x6c, 0x69, 0x74, 0x79, 0x12, 0x30, 0x0a, 0x0a, 0x73, 0x6f, 0x72, 0x74, 0x5f, 0x6f,
	0x72, 0x64, 0x65, 0x72, 0x18, 0x03, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x11, 0x2e, 0x72, 0x61, 0x63,
	0x69, 0x6e, 0x67, 0x2e, 0x53, 0x6f, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x52, 0x09, 0x73,
	0x6f, 0x72, 0x74, 0x4f, 0x72, 0x64, 0x65, 0x72, 0x22, 0x29, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x52,
	...
	,
...
var file_racing_racing_proto_goTypes = []interface{}{
	...
	(*SortOrder)(nil),              // 5: racing.SortOrder
...
var file_racing_racing_proto_depIdxs = []int32{
	...
	5, // 2: racing.ListRacesRequestFilter.sort_order:type_name -> racing.SortOrder
